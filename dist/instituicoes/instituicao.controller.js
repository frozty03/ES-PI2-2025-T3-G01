...
let InstituicaoController = class InstituicaoController {
    ...
    async create(userId, createInstituicaoDto) {
        return this.instituicaoService.createInstituicao(createInstituicaoDto, userId);
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, criarInstituicao_dto_1.CreateInstituicaoDto]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], InstituicaoController.prototype, "delete", null);
__decorate([
